...
callback:(OIDAuthStateAuthorizationCallback)callback {
    return [self authStateByPresentingAuthorizationRequest:authorizationRequest UICoordinator:UICoordinator callback:callback customDelegate:nil];
}
    ...
    id<OIDAuthorizationFlowSession> authFlowSession = [OIDAuthorizationService
                                                       ...
                                                       callback:^(OIDAuthorizationResponse *_Nullable authorizationResponse,
                                                           ...
                                                           if (authorizationResponse) {
                                                               if ((!customDelegate || (customDelegate && [customDelegate shouldPerformTokenRequest]))
