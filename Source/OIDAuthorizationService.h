...
/*! @brief Represents a block that returns if the given url should be handled.
 */
@protocol OIDAuthFlowSessionCustomDelegate <NSObject>

- (BOOL)shouldHandleURL:(NSURL *)url;
- (BOOL)shouRequestAndResposeScopeMatch;
